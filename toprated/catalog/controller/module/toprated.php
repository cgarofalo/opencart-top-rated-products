...
namespace Opencart\Catalog\Controller\Extension\Toprated\Module;
/**
 * Class TopRated
 *
 * @package Opencart\Catalog\Controller\Extension\Toprated\Module
 */
class TopRated extends \Opencart\System\Engine\Controller {
	...
	public function index( array $setting ): string {
		...
		// Top Rated
		$this->load->model( 'extension/toprated/module/toprated' );

		// Image
		$this->load->model( 'tool/image' );

		$results = $this->model_extension_toprated_module_toprated->getTopRated( $setting['limit'] );
		...
		if ( $results ) {
			...
			return $this->load->view( 'extension/toprated/module/toprated', $data );
		} else {
			return '';
		}
	}
